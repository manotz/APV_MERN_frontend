          ...
          {msg && <Alerta alerta={alerta}/>}
            ...
            <form  onSubmit={handleSubmit}>
                <div className="my-3">
                  ...
                  name="nombre" value={perfil.nombre || ''} onChange={e => setPerfil({
                    ...perfil,
                ...
                <div className="my-3">
                  ...
                  <input type="text" className="border bg-gray-50 w-full p-2 mt-5 rounded-lg "
                  name="web" value={perfil.web || ''} onChange={e => setPerfil({
                    ...perfil,
                    [e.target.name]  : e.target.value
                ...
                <div className="my-3">
                  ...
                  <input type="text" className="border bg-gray-50 w-full p-2 mt-5 rounded-lg "
                  name="telefono" value={perfil.telefono || ''} onChange={e => setPerfil({
                    ...perfil,
                    [e.target.name]  : e.target.value
                ...
                <div className="my-3">
                  ...
                  <input type="text" className="border bg-gray-50 w-full p-2 mt-5 rounded-lg "
                  name="email" value={perfil.email || ''} onChange={e => setPerfil({
                    ...perfil,
                    [e.target.name]  : e.target.value
                ...
                <input type="submit" className="bg-indigo-700 px-10 py-3 font-bold text-white rounded-lg uppercase w-full mt-5 " value="Guardar Cambios"   />
            </form>
        </div>
